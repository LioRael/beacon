...
```bash
shasum -a 256 -c beacon-v0.3.2-aarch64-apple-darwin.tar.gz.sha256
tar -xzf beacon-v0.3.2-aarch64-apple-darwin.tar.gz
install -m 755 beacon-v0.3.2-aarch64-apple-darwin/beacon /usr/local/bin/beacon
```
...
node scripts/verify-release-version.mjs v0.3.2
```
